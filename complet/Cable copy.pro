...
Function {
  ...
  sigma[Region[{Insolating_PET, Insolating_PP, Insolating_PVC, Insolating_XLPE}]] = 1e-12; // note Louis, useless as not conducting
  sigma[Region[{Ind_1, Ind_2, Ind_3, Copper}]] = 5.99e7;
    ...
    PostOperation{
      ...
      { Name Post_Mag; NameOfPostProcessing MQS_a_2D;
        Operation {
          ...
          Print[ j , OnElementsOf Region[{DomainC_Mag}],
            Name "j [A/m^2]", File "res/j_inds.pos" ];
  ...
  PostProcessing {
    { Name The; NameOfFormulation The_T;
      Quantity {
        ...
        { Name qVol; Value{ Term { [ qVol[] ] ; In Ind_1; Jacobian Vol; } } }
      }
    }
  ...
  PostOperation {
    { Name Post_MagTher ; NameOfPostProcessing The ;
      Operation {
        ...
        Print[ qVol, OnElementsOf Ind_1 , File "map_QVol.pos"];
      }
    }
  }
