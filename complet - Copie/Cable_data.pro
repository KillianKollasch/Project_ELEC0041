...
DefineConstant[ cl = {0.01, Name "Mesh size", Visible 1} ];
...
DefineConstant[ t_binder = {1.9*mm, Name "Input/1Geometry/cable/(no armour) Thickness of binder layer", Highlight "AliceBlue", Visible (armour == 0)}];
EndIf
